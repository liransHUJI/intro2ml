...
class LogisticModule(BaseModule):
    ...
    def compute_output(self, X: np.ndarray, y: np.ndarray, **kwargs) -> np.ndarray:
        """
        Compute the output value of the logistic regression objective function at point self._weights
    ...
    def compute_jacobian(self, X: np.ndarray, y: np.ndarray, **kwargs) -> np.ndarray:
        """
        Compute the gradient of the logistic regression objective function at point self._weights
        ...
        output: ndarray of shape (n_features,)
            Derivative of function with respect to self._weights at point self._weights
        """
        raise NotImplementedError()
...
class RegularizedModule(BaseModule):
    ...
    def __init__(self,
        ...
        """
        super().__init__()
        self._fidelity_module, self._regularization_module, self._lam = fidelity_module, regularization_module, lam
    ...
    def compute_output(self, **kwargs) -> np.ndarray:
        """
        Compute the output value of the regularized objective function at point self._weights
    ...
    def compute_jacobian(self, **kwargs) -> np.ndarray:
        """
        Compute module derivative with respect to self._weights at point self._weights
        ...
        -------
        output: ndarray of shape (n_in,)
            Derivative with respect to self._weights at point self._weights
        """
        raise NotImplementedError()
    ...
    def weights(self, weights: np.ndarray) -> None:
        ...
        In case self._include_intercept is set to True, weights[0] is regarded as the intercept
